boot_command     = ["<up><tab> net.ifnames=1 inst.ks=http://{{ .HTTPIP }}:{{ .HTTPPort }}/ol9-x64.ks <enter>"]
boot_wait        = "5s"
disk_size        = 4096
format           = "qcow2"
headless         = "false"
...
http_port_min    = 8888
iso_checksum     = "none"
iso_url          = "/home/bd/iso/OracleLinux-R9-U0-x86_64-dvd.iso"
output_directory = "ol9-x64-{{isotime `20060102`}}"
qemuargs         = [["-m", "2048"], ["-display", "vnc=localhost:0"], ["-cpu", "host"]]
